...
public class PlayerPickup : NetworkBehaviour
{
    ...
    public override void OnStartClient()
    {
        ...
        cam = Camera.main;
        worldObjectHolder = GameObject.FindGameObjectWithTag("WeaponItem").transform;
    }
    ...
    void SetObjectInHandObserver(GameObject obj, Vector3 position, Quaternion rotation, GameObject player)
    {
        ...
        obj.GetComponent<GunSystem>().enabled = true;
    }
    ...
    void DropObjectObserver(GameObject obj, Transform worldHolder)
    {
        ...
        obj.GetComponent<GunSystem>().enabled = false;
